        ...
        <Container className="container">
          <div className="row">
            <div className="col-lg-7 my-3">
              ...
              <h5 className="my-3">in 2022</h5>
              <Quote>
                484 LTD was founded in Exton, Pennsylvania.
              </Quote>
              <p className="text-end"> - 484 LTD</p>
            </div>
...
function Badge() {
  return (
    <BadgeContainer>
      ...
      <BadgeText>
        No central person or company owns it. Rather, information is stored
        across a system of many personal computers so that there is no
        middleman. It’s decentralized and distributed so that no one person can
        take it down or corrupt it. However, anyone can use the system and help
        run it, as information is protected through cryptography.
      </BadgeText>
      <BadgeRef href="https://www.forbes.com/sites/theyec/2018/03/09/eight-ways-blockchain-will-impact-the-world-beyond-cryptocurrency/?sh=c23ca8e18832">
        - Forbes
      </BadgeRef>
    </BadgeContainer>
  );
