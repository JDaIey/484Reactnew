      ...
      <NavbarContainer className="container-xxl">
        <Link to="/" className="no-decoration">
          <div className="d-flex align-items-center">
            <img src={logo} height={30} className="me-3" />
            <Brand>
              484 <LName>LTD</LName>
            </Brand>
          </div>
        ...
        <div className="disable-when-mobile">
          {pathname === "/" ? (
            <MenuContainer>
              <Menu href="#me">Home</Menu>
              <Menu href="#skills">Company Info</Menu>
              <Menu href="https://x.com/484LTD/jobs">Careers</Menu>
              <Menu href="#skills">About</Menu>
